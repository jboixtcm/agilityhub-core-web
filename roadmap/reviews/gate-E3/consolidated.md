...
| Task | Repo | Content | Depends on | Status 25-09 22:45 |
|---|---|---|---|---|
...
| **E3-T11** | api | Audit re-run after the fixes | E3-T07…T10, E3-T12…T16 | ready (opened 25-09 22:45) |
...
| **E3-W12** | web | Screen 13 without `/parameters`: the document types from `GET /me/dogs`, «Nivell» only when the dog carries `level`, mocks that refuse `/parameters` to members (added 25-09, from the E4-W08 report); the footer's registered-office line | api E3-T16 | changes requested (round 1: the real-core run needs the E3-T16 image) |
