...
Added 24-09 (the gate audit's result: **fail**, see `roadmap/reviews/gate-E3/`): E3-W05 becomes the pre-fix baseline. The fixes are **E3-W06** (public signup: NIE/passport at submission, retries, error mapping, the consent version, the signup minors; no api change needed, ready now), **E3-W07** (snapshot adoption, D2 and D1) and **E3-W08** (the 19 card from the per-plan quote, signed uploads, screen 13, the signup flags). E3-W07 and E3-W08 open when api E3-T08 and E3-T09 are published. **E3-W09** re-runs the audit; the organizer opens it.

### Gate E3 (front — checked by the organizer — **reopened 24-09 by the gate audit**)
...
- [x] Screenshots of 16–19, enviada, D1, D2 against the mockups; `signup`, `admin-dashboard`, `admin-census` keys complete in ca/es/en; vocabulary lint green. — organizer 24-09: D2 re-shot in round 2; the two cosmetic leftovers (success toast tone, «fa 0 dies») go to E3-W04. — **reopened 24-09: the organizer withdraws this tick.** It had checked D2 only; the 18/19 screenshots of the same run already showed the raw placeholders, no total and the wrong option labels. Re-checked on the E3-W09 screenshots. — **organizer 26-09: re-checked on E3-W09's run** (`6cf867e`, core `1308743`): 16–19, «enviada», 13, 01, D1 and D2 against their mockups. The defects left go to E4-W12, and the cosmetics to INC-11; `i18n:check` green.
...
- [x] Gate audit 24-09 (`roadmap/reviews/gate-E3/consolidated.md`: fail, 1 blocker and 21 majors across both repos): E3-W06, E3-W07 and E3-W08 verified; the E3-W09 re-run green; the organizer re-checks every E3 screenshot against its mockup. — **organizer 26-09:** E3-W06…W08 and E3-W10…W12 verified; E3-W09 verified (green at `6cf867e`), with its screenshots re-checked.
