...
- 26-09-2026 · verificació d'E5-W01: la nota de límit de 29 segons `details.week` (amb `CURRENT`, el literal del mockup; amb `NEXT`, el de B1) i `details.unit`; R-08-08, `Idempotency-Key` un UUID per cos, no el `seatHoldId`; R-08-10 i §6, `BOOKING_NOT_CANCELLABLE` és 422 (el catàleg).
