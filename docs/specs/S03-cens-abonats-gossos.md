...
| GET | `/me/dogs` | MEMBER | — | sí | Agregat de 13 (R-03-02, R-03-18) | — | `200 {dogs: [{id, status, name, breed, sex, ageYears, photoUrl, level?, instructorNote?, tasks?, documents[], freeTrainingAllowed, licenses[], pack?}], canAddDog}` |
