...
| # | Decisió | On | Per què |
|---|---|---|---|
| E22 | Treure «Reservable per entrenaments» o desactivar una pista amb reserves d'entrenament vives segueix **S09 R-09-13**: `409 RING_HAS_BOOKINGS` llevat que l'ADMIN enviï `cancelBookings: true` (les reserves passen a `CANCELLED_BY_CLUB / RING_NOT_RESERVABLE`). `RING_IN_USE` queda per a la resta de R-05-07 | S05 R-05-08 · T-05-28 · codi a E5-T09 | S05 i S09 es contradeien; la regla de S09 és posterior i deixa l'ADMIN resoldre-ho en un sol pas en comptes de bloquejar-lo |
